  ...
  void _navigateToCreatedTestDetail(Map<String, dynamic> test) async {
    ...
    if (curr_quiz.isComplete == false) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              TestadminPage(testId: test['ref'].id.toString()),
        ),
      );
    }
  }
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const DashboardPage()), // Replace with your DashboardPage
                );
              },
            ),
            const Spacer(),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: InkWell(
                              onTap: () => _navigateToAnsweredTestDetail(
                                  answeredTests[reverseIndex]),
                              child: Container(
                                width: 150,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: const Icon(
                                        ...
                                        size: 100,
                                        color: Color.fromRGBO(128, 202, 255, 1),
                                      ),
                                    ),
                                    Text(
                                      answeredTests[reverseIndex]['name'],
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            color: const Color.fromRGBO(179, 223, 255, 1),
                            child: InkWell(
                              onTap: () => _navigateToCreatedTestDetail(
                                  createdTests[reverseIndex]),
                              child: Container(
                                width: 150,
                                padding: const EdgeInsets.all(8.0),
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      createdTests[reverseIndex]['name'],
                                      style: const TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: 14,
                                      ),
...
class CreateOrAnswerTestPage extends StatelessWidget {
  ...
  CreateOrAnswerTestPage(
      {required this.onTestCreated, required this.onTestAnswered});
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      DocumentReference doc =
                          await db.collection("tests").add(curr_quiz.toMap());
                      curr_quiz.id = doc.id;
                      Navigator.pop(context);
                      Navigator.push(
                          context,
                  ...
                  child: InkWell(
                    onTap: () async {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AnswerTestPage()));
                    },
                    child: Container(
                        height: 50,
                        margin: const EdgeInsets.all(1),
